...
if __name__ == '__main__':
    import asyncio
    url = 'https://www.doubao.com/video-sharing?share_id=35083351704233730&source_type=mobile&video_id=v0269cg10004d5e6oefog65smlkr0jl0&share_scene=video_viewer'
    print(asyncio.run(doubao_video_parse(url)))